            ...
            <div class="row about_row">
                <div class="col-lg-6">
                    <div class="about_content">
                        <div class="text_highlight">Pellentesque sit amet elementum ccumsan sit amet mattis eget,
                            tristique at leo. Vivamus massa.Tempor massa et laoreet .Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit.
                        </div>
                        <div class="about_text">
                            <p>Pellentesque sit amet elementum ccumsan sit amet mattis eget, tristique at leo. Vivamus
                                massa.Tempor massa et laoreet .Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Sed eu laoreet ante, sollicitudin volutpat quam. Vestibulum posuere malesuada ultrices.
                                In pulvinar rhoncus lacus at aliquet. Nunc vitae lacus varius, auctor nisi sit amet,
                                consectetur mauris. Curabitur sodales semper est, vel faucibus urna laoreet vel. Ut
                                justo diam, sodales non pulvinar at, vulputate quis neque. Etiam aliquam purus vel
                ...
                <div class="col-lg-6">
                    <div class="about_image"><img src="img/about_1.jpg" alt=""></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row team_row">
                ...
                <div class="col-xl-3 col-md-6 team_col">
                    <div class="team_item d-flex flex-column align-items-center justify-content-start text-center">
                        <div class="team_image"><img src="img/team_1.jpg" alt=""></div>
                ...
                <div class="col-xl-3 col-md-6 team_col">
                    <div class="team_item d-flex flex-column align-items-center justify-content-start text-center">
                        <div class="team_image"><img src="img/team_2.jpg" alt=""></div>
                        <div class="team_content">
                ...
                <div class="col-xl-3 col-md-6 team_col">
                    <div class="team_item d-flex flex-column align-items-center justify-content-start text-center">
                        <div class="team_image"><img src="img/team_3.jpg" alt=""></div>
                        <div class="team_content">
                ...
                <div class="col-xl-3 col-md-6 team_col">
                    <div class="team_item d-flex flex-column align-items-center justify-content-start text-center">
                        <div class="team_image"><img src="img/team_4.jpg" alt=""></div>
                        <div class="team_content">
...
@endsection
@section('script')
    <script src="plugins/greensock/TweenMax.min.j"></script>
    <script src="plugins/greensock/TimelineMax.min.j"></script>
    <script src="plugins/scrollmagic/ScrollMagic.min.j"></script>
    <script src="plugins/greensock/animation.gsap.min.j"></script>
    <script src="plugins/greensock/ScrollToPlugin.min.j"></script>
