...
INSERT INTO user (user_id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name,
                  dob, phone, address, loyalty_number, active)
VALUES (1, 'Hieu-iceTea', 'DinhHieu8896@gmail.com', '$2y$10$YKY51A9REcXLZVRAC87AcuXnC.Nb8WK8rD/WgfAVxPSAelLZHQf06', 3,
        '2020-08-08', 'Hieu-iceTea.jpg', 1, 'Đình Hiếu', 'Nguyễn', '1996-08-08', '0868 6633 15', 'Nghệ An', 123456,
        TRUE);
INSERT INTO user (user_id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name,
                  dob, phone, address, loyalty_number, active)
VALUES (2, 'truong-thanh-tu', 'TruongThanhTu03091998@gmail.com',
        '$2y$10$YKY51A9REcXLZVRAC87AcuXnC.Nb8WK8rD/WgfAVxPSAelLZHQf06', 3, '2020-08-08', 'truong-thanh-tu.jpg', 1,
        'Thanh Tú', 'Trương', '1998-09-03', '0359077335', 'Huế', 123456, FALSE);
INSERT INTO user (user_id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name,
                  dob, phone, address, loyalty_number, active)
VALUES (3, 'chanhoa', 'ChanHoa28112k@gmail.com', '$2y$10$YKY51A9REcXLZVRAC87AcuXnC.Nb8WK8rD/WgfAVxPSAelLZHQf06', 3,
        '2020-08-08', 'chanhoa.jpg', 2, 'Chan Hòa', 'Đỗ Thị', '2000-01-01', '0981159826', '', 123456, TRUE);
INSERT INTO user (user_id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name,
                  dob, phone, address, loyalty_number, active)
VALUES (4, 'vuquanghuy2001', 'VuQuangHuyXL1234@gmail.com',
        '$2y$10$YKY51A9REcXLZVRAC87AcuXnC.Nb8WK8rD/WgfAVxPSAelLZHQf06', 3, '2020-08-08', 'vuquanghuy2001.jpg', 1,
        'Quang Huy', 'Vũ', '2000-01-01', '0981159826', '', 123456, TRUE);
INSERT INTO user (user_id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name,
                  dob, phone, address, loyalty_number, active)
VALUES (5, 'tuanpth1909', 'PhamTuanCules20@gmail.com', '$2y$10$YKY51A9REcXLZVRAC87AcuXnC.Nb8WK8rD/WgfAVxPSAelLZHQf06',
        3, '2020-08-08', 'tuanpth1909.jpg', 1, 'Tuân', 'Phạm', '2000-01-01', '0382548442', '', 123456, TRUE);
INSERT INTO user (user_id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name,
                  dob, phone, address, loyalty_number, active)
VALUES (6, 'host', 'ars.codedy@gmail.com', '$2y$10$YKY51A9REcXLZVRAC87AcuXnC.Nb8WK8rD/WgfAVxPSAelLZHQf06', 1,
        '2020-08-08', 'logo_host.png', 1, 'Đình Hiếu', 'Nguyễn', '1996-08-08', '032 87 99 000', 'Hà Nội', NULL, TRUE);
INSERT INTO user (user_id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name,
                  dob, phone, address, loyalty_number, active)
VALUES (7, 'admin', 'ars.codedy@gmail.com', '$2y$10$YKY51A9REcXLZVRAC87AcuXnC.Nb8WK8rD/WgfAVxPSAelLZHQf06', 2,
        '2020-08-08', 'logo_admin.gif', 1, '', '', '2020-08-08', '', '', NULL, TRUE);
INSERT INTO user (user_id, user_name, email, password, level, email_verified_at, image, gender, first_name, last_name,
                  dob, phone, address, loyalty_number, active)
VALUES (8, 'member', 'ars.codedy@gmail.com', '$2y$10$YKY51A9REcXLZVRAC87AcuXnC.Nb8WK8rD/WgfAVxPSAelLZHQf06', 3,
        '2020-08-08', 'logo_member.png', 1, '', '', '2020-08-08', '', '', NULL, TRUE);

INSERT INTO extra_service (extra_service_id, name, price, image, active, description)
    VALUE (1, 'Luggage and special services', 110000, 'luggage-and-special-services.jpg', TRUE,
...
INSERT INTO extra_service (extra_service_id, name, price, image, active, description)
    VALUE (2, 'Priority Check-in', 120000, 'priority-check-in.jpg', TRUE,
...
INSERT INTO extra_service (extra_service_id, name, price, image, active, description)
    VALUE (3, 'Business Lounge', 130000, 'business-lounge.jpg', TRUE,
...
INSERT INTO extra_service (extra_service_id, name, price, image, active, description)
    VALUE (4, 'Special meals on the plane', 140000, 'special-meals-on-the-plane.jpg', TRUE,
...
INSERT INTO extra_service (extra_service_id, name, price, image, active, description)
    VALUE (5, 'Special care for babies', 150000, 'special-care-for-babies.jpg', TRUE,
           '<ul style=list-style-type: disc;><li>Baby stroller</li><li>Bassinet service</li><li>Portable in-flight bed for children</li></ul>');
INSERT INTO extra_service (extra_service_id, name, price, image, active, description)
    VALUE (6, 'Special care for the elderly', 160000, 'special-care-for-the-elderly.jpg', FALSE,
           '<ul style=list-style-type: disc;><li>Baby stroller</li><li>Bassinet service</li><li>Portable in-flight bed for children</li></ul>');
...
INSERT INTO promotion (promotion_id, code, title, discount, qty_total, qty_remain, start_date, expiration_date, active,
                       description)
...
INSERT INTO promotion (promotion_id, code, title, discount, qty_total, qty_remain, start_date, expiration_date, active,
                       description)
VALUES (5, 'VIP5000', 'Giảm giá đặc biệt cho khách hàng VIP', 500000, 20, 18, '2020-12-10', '2020-12-30', TRUE,
        '<p>mô tả</p>');
INSERT INTO promotion (promotion_id, code, title, discount, qty_total, qty_remain, start_date, expiration_date, active,
                       description)
